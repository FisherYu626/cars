        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-body row">
                    <form action="customer_management.php?a=add" method='POST'>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">客户姓名</span>
                            <input type="txt" class="form-control" placeholder="FISHER626" aria-describedby="sizing-addon1" name="car_name"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">身份证号</span>
                            <input type="txt" class="form-control" placeholder="8888888" aria-describedby="sizing-addon1" name="car_id"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">家庭住址</span>
                            <input type="txt" class="form-control" placeholder="北京" aria-describedby="sizing-addon1" name="car_brand"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">汽车编号</span>
                            <input type="txt" class="form-control" placeholder="000001" aria-describedby="sizing-addon1" name="color"/>
                        </div>
                        <br/>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">购买时间</span>
                            <input type="txt" class="form-control" placeholder="2019-04-15" aria-describedby="sizing-addon1" name="time"/>
                        </div>
                        <br/>
                        <div class="input-group input-group-lg">

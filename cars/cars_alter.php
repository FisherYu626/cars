        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-body row">
                    <form action="cars_management.php?a=alter&id=<?php echo($id) ?>" method='POST'>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">汽车品牌</span>
                            <input type="txt" class="form-control" placeholder="car_brand" aria-describedby="sizing-addon1" name="car_num"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">销售日期</span>
                            <input type="txt" class="form-control" placeholder="2019-04-06" aria-describedby="sizing-addon1" name="car_brand"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                        ...
                        <br />
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">销售情况</span>

        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li>
                                <a href="/admin/document/customer.php">
                                    <span class="menu-text">
                                        客户信息管理 </span>
            ...
            <div class="page-content">
                ...
                <div class="page-body row">
                    <form action="cars_management.php?a=sales_add" method='POST'>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">汽车编号</span>
                            <input type="txt" class="form-control" placeholder="001" aria-describedby="sizing-addon1" name="car_name"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">汽车型号</span>
                            <input type="txt" class="form-control" placeholder="奔驰" aria-describedby="sizing-addon1" name="car_id"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">成交金额</span>
                            <input type="txt" class="form-control" placeholder="12000" aria-describedby="sizing-addon1" name="car_num"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">销售日期</span>
                            <input type="txt" class="form-control" placeholder="2009-09-08" aria-describedby="sizing-addon1" name="car_brand"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">

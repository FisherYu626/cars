        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-body row">
                    <form action="useraction.php?a=alter&id=<?php echo ($id) ?>" method='POST'>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">更新密码</span>
                            <input type="txt" class="form-control"  aria-describedby="sizing-addon1" name="pwd" />
                        </div>
                        <div class="input-group input-group-lg">

        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <div class="page-body row">
                    <form action="customer_management.php?a=alter&id=<?php echo($id) ?>" method='POST'>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="sizing-addon1">身份证号</span>
                            <input type="txt" class="form-control" placeholder="88888888" aria-describedby="sizing-addon1" name="car_num"/>
                        </div>
                        <br />
                        <div class="input-group input-group-lg">
                        ...
                        <div class="input-group input-group-lg">
                            ...
                            <input type="txt" class="form-control" placeholder="0000001" aria-describedby="sizing-addon1" name="color"/>
                        </div>
                        <br/>
                        <div class="input-group input-group-lg">
